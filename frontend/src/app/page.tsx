  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="relative h-full">
        <div className="m-5  bg-gray-200/60 inline-flex gap-2 justify-center items-center px-4 py-2 rounded-full [@media(max-width:849px)]:hidden [@media(min-width:1445px)]:hidden text-black font-semibold cursor-pointer hover:bg-gray-100" onClick={()=>setSidebarOpen(!sidebarOpen)}>
          <span>Filters</span> 
